...
def get_additional():
  ...
  return jsonify([
        ...
        {"bio":"This is a sample sentence intended to serve as default text in a design or layout, providing a visual sense of how content might appear in a finished project. It continues with a second sentence that adds more length and structure, helping to demonstrate how multiple lines of text will look within the overall composition.","type":"yt","title": "Youtube", "link": "https://www.youtube.com/@silvxx-1247",'img':url_for('static', filename='images/tzuyu.jpg', _external=True)},
    ])
